...
public abstract class AbstractBean {
	 ...
	 * PropertyChangeSupport cannot be extended directly because it requires a bean
	 ...
	 * If <code>propertyName</code> or <code>listener</code> is null, no exception
	 ...
	 * listeners were added, then VetoableChangeListenerProxy wrappers will returned
	 * <p>
	 * 
	...
	/**
	 * Fire a vetoable property update to any registered listeners. If anyone vetos
	 * the change, then fire a new event reverting everyone to the old value and
