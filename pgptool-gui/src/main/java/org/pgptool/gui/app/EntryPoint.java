...
public class EntryPoint {
  ...
  public static void main(String[] args) {
    DOMConfigurator.configure(
        EntryPoint.class.getClassLoader().getResource("pgptool-gui-log4j.xml"));
  ...
  private static void reportAppInitFailureMessageToUser(Window window, Throwable t) {
    ...
    msg += "\r\n" + versionInfo;
    UiUtils.messageBox(
        UiUtils.actionEvent(window, "reportAppInitFailureMessageToUser"),
        msg,
        "PGP Tool startup failed" + versionInfo,
        JOptionPane.ERROR_MESSAGE);
  }

  public static void reportExceptionToUser(
    ...
    msgs += "\r\n" + versionInfo;
    UiUtils.messageBox(
        originAction, msgs, Messages.get("term.error") + versionInfo, JOptionPane.ERROR_MESSAGE);
  }
