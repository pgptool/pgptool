...
/**
 * Simple impl of {@link ProgressHandler} that uses standard {@link ProgressMonitor} to render
 * progress
 *
...
public class ProgressMonitorRenderer implements ProgressHandler {
  ...
  public void onProgressUpdated(Progress progress) {
    if (progressMonitor == null) {
      progressMonitor =
          new ProgressMonitor(parentComponent, text(progress.getOperationCode()), "", 0, 100);
    } else {
