...
/**
 * Simple service for key-value properties. name might a little bit unusual, but it was by intention
 * to avoid confusing it with encryption keys and key pairs.
 *
