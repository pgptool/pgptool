...
public class DecryptedFile implements DtoBase {
  ...
  public boolean equals(Object obj) {
    ...
    if (decryptedFile == null) {
      if (other.decryptedFile != null) return false;
    } else if (!decryptedFile.equals(other.decryptedFile)) return false;
    if (encryptedFile == null) {
      if (other.encryptedFile != null) return false;
    } else if (!encryptedFile.equals(other.encryptedFile)) return false;
    return true;
  }
