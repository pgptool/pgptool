...
/**
 * This structure is used to store file size and checksum. This is how we see if target file is
 * different from source file. Do not confuse this class with fingerprints in cryptography
 *
 * @author sergeyk
 */
