 ...
 * particular hints, it will just queue them when {@link #scheduledHints}
 *
 * @author sergeyk
 */
public class HintsCoordinatorImpl implements HintsCoordinator {
  ...
  public synchronized void scheduleHint(HintPm hintPm) {
    ...
    if (scheduledHints.contains(hintPm)
        || (hintsHolder != null && hintPm.equals(hintsHolder.getHint()))) {
      return;
    }
  ...
  @Override
  public synchronized void cancelHint(HintPm hintPm) {
    Preconditions.checkArgument(hintPm != null);
