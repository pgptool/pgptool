...
/**
 * NOTE: This is not actual DTO and we're not going to serialize that but we use it as a dirty
 * workaround so we can use instances of this class in conjunction with {@link EntityChangedEvent}
 *
 * @author sergeyk
 */
