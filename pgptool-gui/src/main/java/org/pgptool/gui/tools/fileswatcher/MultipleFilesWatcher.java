...
public class MultipleFilesWatcher {
  ...
  /**
   * since WatchService is not notifying us in case of parent folders removal AND we don't want to
   * overcomplicate code to watch ALL parent folders we're having here another simple thread that
   * will go and check folders existance
   */
