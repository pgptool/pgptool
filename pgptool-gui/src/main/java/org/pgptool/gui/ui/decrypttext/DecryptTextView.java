...
public class DecryptTextView extends DialogViewBaseEx<DecryptTextPm> {
  private JPanel pnl;
  ...
  private Component buildControllsPanel() {
    ...
    panelMissingPrivateKeyWarning =
        EncryptOneView.wrapIntoMessagePanel(
            lblNoPrivateKeysSelectedWarning, new Color(253, 221, 191));
  ...
  protected void internalBindToPm() {
    ...
    bindingContext.registerOnChangeHandler(
        pm.getIsShowMissingPrivateKeyWarning(), onShowMissingPrivateKeyWarning);
  }
  ...
  protected void handleDialogShown() {
    ...
    onShowMissingPrivateKeyWarning.handlePropertyChanged(
        pm,
        pm.getIsShowMissingPrivateKeyWarning().getPropertyName(),
        null,
