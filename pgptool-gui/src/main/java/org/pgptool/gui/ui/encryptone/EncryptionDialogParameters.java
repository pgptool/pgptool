 ...
 *     <p>TBD: Move this DTO to appropriate package near {@link EncryptionParamsStorage} BUT !!!!!!!
 *     This must be performed as a part of upgrade procedure to avoid screwing up peoples current
 *     settings!!
 */
public class EncryptionDialogParameters implements Serializable, DtoBase {
  ...
  /**
   * If true it means this instance was created by decrypt dialog to help suggest parameters on
   * encryption
   */
