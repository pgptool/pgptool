...
public class EncryptTextView extends DialogViewBaseCustom<EncryptTextPm> {
	...
	private Component buildControllsPanel() {
		...
		btns.add(btnPasteSourceFromClipboard = new JButton(), BorderLayout.WEST);
	...
	protected void internalBindToPm() {
		...
		bindingContext.setupBinding(pm.actionSelectRecipientsFromClipboard, btnSelectRecipientsFromClipboard);
