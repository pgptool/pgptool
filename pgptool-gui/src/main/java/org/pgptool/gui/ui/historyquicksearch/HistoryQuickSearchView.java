...
public class HistoryQuickSearchView extends ViewBaseEx<HistoryQuickSearchPm> {
  ...
  protected void internalInitComponents() {
    ...
    sgl.setColSize(
        1,
        UiUtils.getFontRelativeSize(text("action.cancel").length()),
        SgLayout.SIZE_TYPE_ASKCOMPONENT);
    sgl.setRowSize(3, UiUtils.getFontRelativeSize(26), SgLayout.SIZE_TYPE_WEIGHTED);
    panelRoot = new JPanel(sgl);

    CompoundBorder panelBorder =
  ...
  protected void internalBindToPm() {
    ...
    tableModelChangeHandler.handlePropertyChanged(
        this, pm.getRowsTableModel().getPropertyName(), null, pm.getRowsTableModel().getValue());
        ...
        public void handlePropertyChanged(
          ...
          tableColumnsGeometryPersister =
              new TableColumnsGeometryPersisterImpl(
                  table, "tblHstQSrch", uiGeom, scheduledExecutorService);
  ...
  protected void internalRenderTo(Container owner, Object constraints) {
    ...
    if (window == null) {
      ...
      window.setMinimumSize(
          new Dimension(UiUtils.getFontRelativeSize(50), UiUtils.getFontRelativeSize(25)));

      windowGeometryPersister =
          new WindowGeometryPersisterImpl(window, "histQSrch", uiGeom, scheduledExecutorService);
