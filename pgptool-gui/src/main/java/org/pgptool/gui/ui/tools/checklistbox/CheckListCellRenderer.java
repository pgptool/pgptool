...
/**
 * TBD: This impl is not even close to the capabilities of {@link DefaultListCellRenderer}, but it's
 * ok for now
 *
 * @author sergeyk
 */
  ...
  public CheckListCellRenderer(Function<E, Boolean> checkStateSupplier) {
    ...
    focusedBorder =
        BorderFactory.createLineBorder(
            UIManager.getColor("List.focusSelectedCellHighlightBorder"), 1);
