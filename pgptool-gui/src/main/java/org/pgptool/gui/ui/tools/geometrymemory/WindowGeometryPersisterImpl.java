...
public class WindowGeometryPersisterImpl extends ComponentAdapter
    implements WindowGeometryPersister {
   ...
   */
  public WindowGeometryPersisterImpl(
      Window window,
      String windowId,
  ...
  public void componentResized(ComponentEvent e) {
    ...
    sizeSetter =
        scheduledExecutorService.schedule(
            () -> configPairs.put(keySize(), window.getSize()), DELAY, DELAY_TIME_UNIT);
  }
