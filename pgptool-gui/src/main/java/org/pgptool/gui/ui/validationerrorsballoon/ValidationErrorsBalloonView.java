...
public class ValidationErrorsBalloonView
  ...
  private static Border buildErrorBorder(JComponent component) {
    if (component.getBorder() == null) {
      ...
      return BorderFactory.createMatteBorder(
          borderInsets.top, borderInsets.left, borderInsets.bottom, borderInsets.right, Color.RED);
    }
  }
  ...
  private String getValidationErrorMessage(ValidationError ve) {
    return I18nUtils.buildMessage(
        ve, EntryPoint.INSTANCE.getApplicationContext(), LocaleContextHolder.getLocale());
  }
