 ...
 *
 * <p>NOTE: This impl is very simple and limited. I.e. it doens't support extent and doesn't perform
 * all those checks performed by {@link DefaultBoundedRangeModel}
 *
 * @author sergeyk
 */
public class ModelSliderProperty extends ModelProperty<Integer> {
  ...
  private final BoundedRangeModel boundedRangeModel =
      new BoundedRangeModel() {
        ...
        @Override
        public int getValue() {
          return ModelSliderProperty.this.getValue() == null
              ? 0
              : ModelSliderProperty.this.getValue();
        }
  ...
  private final ModelSliderPropertyAccessor modelSliderPropertyAccessor =
      new ModelSliderPropertyAccessor() {
        @Override
        ...
        public void removePropertyChangeListener(
            PropertyChangeListener propertyChangeBoundHandler) {
  ...
  private final PropertyChangeListener wrapperForChangeListener = evt -> fireStateChanged();

  public ModelSliderProperty(
      Object source,
      ValueAdapter<Integer> valueAdapter,
      int minimum,
      int maximum,
      String propertyName) {
  ...
  /**
   * NOTE: This is another notification "road". We have to implement it because it's part of
   * BoundedRangeModel contract
   */
