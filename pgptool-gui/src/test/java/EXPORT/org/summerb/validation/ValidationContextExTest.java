...
/**
 * See for valid and invalid examples
...
public class ValidationContextExTest {
	 ...
	 */
	@ParameterizedTest
	@ValueSource(strings = { "very.common@example.com", "disposable.style.email.with+symbol@example.com",
			...
			"test/test@test.com", "example@s.example", "\"john..doe\"@example.org", "mailhost!username@example.org",
			"user%example.com@example.org", "user-@example.org", "postmaster@[123.123.123.123]" })
	public void testValidateEmailFormat_expectOkForUsualEmail(String email) throws FieldValidationException {
	...
	public void testValidateEmailFormat_expectFailForInvalidEmails(String email) throws FieldValidationException {
